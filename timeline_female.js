// ============================================
// timeline_female.js - Timeline Female
...
window.TIMELINE_DATA.female = {
  id: 'female',
  label: 'Female',

  characterBuilder: {
    basePath: 'assets/character-builder/female',
    available: false,
    defaultAppearance: {
      body: 'body_light',
      hair: null,
    ...
    bodies: [
      { id: 'body_light', label: 'Claire', src: 'assets/character-builder/female/body/body_light.png', owned: true },
      { id: 'body_medium', label: 'Medium', src: 'assets/character-builder/female/body/body_medium.png', owned: true },
      { id: 'body_dark', label: 'Foncee', src: 'assets/character-builder/female/body/body_dark.png', owned: true }
    ],
