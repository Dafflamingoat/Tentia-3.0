...
window.TIMELINE_DATA.billaud = {
  ...
  avatars: [
    ...
    { id: 'avatar_redead',    name: 'Avatar Red Dead Redemption',      src: 'assets/avatars/timelines/billaud/avatar_redead.png',    owned: false },
    { id: 'avatar_zombie',    name: 'Avatar Left for Dead II',         src: 'assets/avatars/timelines/billaud/avatar_zombie.png',    owned: false },
    { id: 'avatar_imperial',  name: 'Avatar Imperial',                 src: 'assets/avatars/timelines/billaud/avatar_imperial.png',  owned: false },
    { id: 'avatar_matrix',    name: 'Avatar Matrix',                   src: 'assets/avatars/timelines/billaud/avatar_matrix.png',    owned: false },
  ...
  skins: [
    ...
    { id: 'skin_gogeta',          name: 'Gogeta',         folder: 'timelines/billaud/Skin_Gogeta',        owned: false },
  ...
  backgrounds: [
    ...
    { id: 'bg_billaud_2',  name: 'White',          bg1: 'assets/background/timelines/billaud/bg2_frame1.png',  bg2: 'assets/background/timelines/billaud/bg2_frame2.png',  owned: true  },
    { id: 'bg_billaud_3',  name: 'Fallout',        bg1: 'assets/background/timelines/billaud/bg3_frame1.png',  bg2: 'assets/background/timelines/billaud/bg3_frame2.png',  owned: false },
    { id: 'bg_billaud_4',  name: 'Cyberpunk',      bg1: 'assets/background/timelines/billaud/bg4_frame1.png',  bg2: 'assets/background/timelines/billaud/bg4_frame2.png',  owned: false },
    { id: 'bg_billaud_5',  name: 'The Witcher',    bg1: 'assets/background/timelines/billaud/bg5_frame1.png',  bg2: 'assets/background/timelines/billaud/bg5_frame2.png',  owned: false },
    { id: 'bg_billaud_6',  name: 'Red Dead ',      bg1: 'assets/background/timelines/billaud/bg6_frame1.png',  bg2: 'assets/background/timelines/billaud/bg6_frame2.png',  owned: false },
  ...
  pets: {
    pet1: {
      ...
      evolutions: [
        ...
        { minLevel: 16, maxLevel: 34, name: 'Carabaff',      sprite1: 'assets/pets/timelines/billaud/pet1_evo2_f1.png', sprite2: 'assets/pets/timelines/billaud/pet1_evo2_f2.png' },
        { minLevel: 35, maxLevel: 50, name: 'Tortank',       sprite1: 'assets/pets/timelines/billaud/pet1_evo3_f1.png', sprite2: 'assets/pets/timelines/billaud/pet1_evo3_f2.png' },
      ],
  ...
  levelRewards: {
    ...
    63: [{ type: 'avatar',     id: 'avatar_matrix' }],
    65: [{ type: 'background', id: 'bg_billaud_9' }],
    67: [{ type: 'skin',       id: 'skin_matrix' }],
